...
#include "MyProject/Variant_Combat/AI/CombatEnemySpawner.h"
...
const UECodeGen_Private::FImplementedInterfaceParams Z_Construct_UClass_ACombatEnemySpawner_Statics::InterfaceParams[] = {
	{ Z_Construct_UClass_UCombatActivatable_NoRegister, (int32)VTABLE_OFFSET(ACombatEnemySpawner, ICombatActivatable), false },  // 2778428383
};
...
// ********** Begin Registration *******************************************************************
struct Z_CompiledInDeferFile_FID_Studying_UE5Sample_MyProject_Source_MyProject_Variant_Combat_AI_CombatEnemySpawner_h__Script_MyProject_Statics
{
	static constexpr FClassRegisterCompiledInInfo ClassInfo[] = {
		{ Z_Construct_UClass_ACombatEnemySpawner, ACombatEnemySpawner::StaticClass, TEXT("ACombatEnemySpawner"), &Z_Registration_Info_UClass_ACombatEnemySpawner, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(ACombatEnemySpawner), 138797200U) },
	};
};
static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Studying_UE5Sample_MyProject_Source_MyProject_Variant_Combat_AI_CombatEnemySpawner_h__Script_MyProject_103854909(TEXT("/Script/MyProject"),
	Z_CompiledInDeferFile_FID_Studying_UE5Sample_MyProject_Source_MyProject_Variant_Combat_AI_CombatEnemySpawner_h__Script_MyProject_Statics::ClassInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_Studying_UE5Sample_MyProject_Source_MyProject_Variant_Combat_AI_CombatEnemySpawner_h__Script_MyProject_Statics::ClassInfo),
	nullptr, 0,
	nullptr, 0);
// ********** End Registration *********************************************************************
